# -*- coding: utf-8 -*-
"""
Created on Wed Feb 28 13:48:01 2018
...
def run(context):
  ...
  try:
    ...
    Stepnr = 90 #How many steps to go through on the first wave
    Stepnr2 = 3 #How many steps to go through on the second wave
    stepln = Width / float(Stepnr) #wavelegth1
    stepln2 = Width / float(Stepnr2) #wavelegth2
    height = 15 #loft distance
    
    ampli = 0.5 #wave1 amplitude
    ampli2 = 9 # wave2 amplitude
